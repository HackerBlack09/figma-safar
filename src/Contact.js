...
function Contact({ search3 }) {
  const { category, colormassiv, local, likefun, savatfun, sizemassiv, btn } =
    ...
    <>
      <div className="container">
        <div className="bigbox">
          <div className="big1">
            <h1 className="padding">Accessories</h1>
            ...
            {local
              ...
              .filter((obj) => {
                if (search3 === "") {
                  ...
                  obj.text
                    .toLowerCase()
                    .includes(search3.toLowerCase().trim()) ||
                  obj.text
                    .toLowerCase()
                    .includes(search3.toLowerCase().trim()) ||
                  obj.price.toString().includes(search3.toLowerCase().trim())
                ) {
                  return obj;
                }
              })
